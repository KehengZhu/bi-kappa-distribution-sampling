...
| G6 | reproducible artifact | FAIL | required evidence is absent: `make verify` was never run (receipt: absent). An absent measurement fails this gate; it never passes it. |
