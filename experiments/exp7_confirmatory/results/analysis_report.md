...
| G6 | reproducible artifact | FAIL | required evidence is absent: derived artifacts were never regenerated and compared. An absent measurement fails this gate; it never passes it. |
